/**
 * Vanilla-owned XR lifecycle state for the Primitive Workshop.
 *
 * This adapter intentionally lives beside the Vanilla Renderer Integration.
 * The React variant has its own copy so neither variant shares XR/session code.
 */
