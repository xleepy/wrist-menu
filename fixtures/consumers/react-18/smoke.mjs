...
assert.equal(await packageVersion('react'), '18.3.1')
assert.equal(await packageVersion('react-dom'), '18.3.1')
assert.equal(await packageVersion('three'), '0.185.1')
assert.equal(await packageVersion('@react-three/fiber'), '8.18.0')
